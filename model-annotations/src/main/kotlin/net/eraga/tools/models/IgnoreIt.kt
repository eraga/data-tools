 ...
 * **IgnoreIt**
 *
 * Interface to enforce callable argument usage through `vararg args: [IgnoreIt]`.
 *
 * [ImplementationSettings.forceUseArgNamesInConstructor] will add vararg of type [IgnoreIt]
